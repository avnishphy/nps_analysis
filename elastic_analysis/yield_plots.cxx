...
void plot_W_distribution() {
    ...
    TH1F *hist_data_q2 = new TH1F("hist_data_q2", "q2 Distribution;Q2 [GeV^2];Counts", nbins, 3,6);
    ...
    TH1F *hist_data_x_fp = new TH1F("hist_data_x_fp", "x focal plane", nbins, -60,30);
    ...
    TH1F *hist_simc_q2 = new TH1F("hist_simc_q2", "q2 Distribution;Q2 [GeV^2];Counts", nbins, 3, 6);
    TH1F *hist_simc_scat_ang = new TH1F("simc_data_scat_angle", "Scattering angle Distribution;angle [degrees];Counts", nbins, 20, 30);
    TH1F *hist_simc_x_fp = new TH1F("hist_simc_x_fp", "x focal plane", nbins, -60,30);
    ...
    for (Long64_t i = 0; i < nentries_data; i++) {
        ...
        if (H_kin_W > 0.92 && H_kin_W < 0.96 && 
            H_cal_etottracknorm > 0.9 &&
             H_cer_npeSum > 0.5 && H_gtr_dp<8.5 && H_gtr_dp>-8.5 && H_gtr_th<0.09 && H_gtr_th>-0.09 && H_gtr_ph<0.055
            && H_gtr_ph>-0.055) {
    ...
    for (Long64_t i = 0; i < nentries_simc; i++) {
        ...
        if (W > 0.92 && W < 0.96 && fhsdelta < 8.5 && fhsdelta > -8.5 && fhsxptar > -0.09 && fhsxptar < 0.09 && fhsyptar > -0.055 && fhsyptar < 0.055) {
    ...
    canvas->Update();
    std::string save_filename1 = Form("/w/hallc-scshelf2102/nps/singhav/nps_analysis/elastic_analysis/elastic_plots/W_%d.png", run);
    ...
    canvas_delta->Update();
    std::string save_filename2 = Form("/w/hallc-scshelf2102/nps/singhav/nps_analysis/elastic_analysis/elastic_plots/delta_%d.png", run);
    ...
    canvas_xptar->Update();
    std::string save_filename3 = Form("/w/hallc-scshelf2102/nps/singhav/nps_analysis/elastic_analysis/elastic_plots/xptar_%d.png", run);
    ...
    canvas_yptar->Update();
    std::string save_filename4 = Form("/w/hallc-scshelf2102/nps/singhav/nps_analysis/elastic_analysis/elastic_plots/yptar_%d.png", run);
    ...
    canvas_ytar->Update();
    std::string save_filename5 = Form("/w/hallc-scshelf2102/nps/singhav/nps_analysis/elastic_analysis/elastic_plots/ytar_%d.png", run);
    ...
    hist_data_q2->Add(hist_dummy_ytar, -1);
    hist_data_q2->Scale(1.0 / hist_data_q2->Integral());
    // double maxQ2 = std::max({hist_simc_q2->GetMaximum(), hist_data_q2->GetMaximum(),hist_dummy_q2->GetMaximum()});
    ...
    canvas_q2->Update();
    std::string save_filename6 = Form("/w/hallc-scshelf2102/nps/singhav/nps_analysis/elastic_analysis/elastic_plots/q2_%d.png", run);
    ...
    // hist_simc_delta->Draw("hist same");
    canvas_x_fp->Update();
    std::string save_filename7 = Form("/w/hallc-scshelf2102/nps/singhav/nps_analysis/elastic_analysis/elastic_plots/xfp_%d.png", run);
    ...
    // hist_simc_delta->Draw("hist same");
    canvas_y_fp->Update();
    std::string save_filename8 = Form("/w/hallc-scshelf2102/nps/singhav/nps_analysis/elastic_analysis/elastic_plots/yfp_%d.png", run);
    ...
    // hist_simc_delta->Draw("hist same");
    canvas_xp_fp->Update();
    std::string save_filename9 = Form("/w/hallc-scshelf2102/nps/singhav/nps_analysis/elastic_analysis/elastic_plots/xpfp_%d.png", run);
    ...
    // hist_simc_delta->Draw("hist same");
    canvas_yp_fp->Update();
    std::string save_filename10 = Form("/w/hallc-scshelf2102/nps/singhav/nps_analysis/elastic_analysis/elastic_plots/ypfp_%d.png", run);
